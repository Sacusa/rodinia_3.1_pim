...
void run_pathfinder(int argc, char** argv, cudaStream_t stream);
...
int calc_path(int *gpuWall, int *gpuResult[2], int rows, int cols,
        int pyramid_height, int blockCols, int borderCols, cudaStream_t stream)
{
...
int main_pathfinder(int argc, char** argv, cudaStream_t stream)
{
    ...
    run_pathfinder(argc, argv, stream);
...
void run_pathfinder(int argc, char** argv, cudaStream_t stream)
{
    ...
    int final_ret = calc_path(gpuWall, gpuResult, rows, cols,
            pyramid_height, blockCols, borderCols, stream);
