...
int main_srad_v1(int argc, char *argv []){
	...
	checkCUDAError_srad_v1("extract");

	time7 = get_time_srad_v1();
	...
	// fflush(NULL);
		...
		checkCUDAError_srad_v1("prepare");
		...
		while(blocks2.x != 0){
			...
			checkCUDAError_srad_v1("before reduce");
			...
			checkCUDAError_srad_v1("after reduce");

		}

		checkCUDAError_srad_v1("before copy sum");
		...
		checkCUDAError_srad_v1("copy sum");
		...
		checkCUDAError_srad_v1("srad2");

	}

	// printf("\n");

	time8 = get_time_srad_v1();
	...
	checkCUDAError_srad_v1("compress");

	time9 = get_time_srad_v1();
	...
	checkCUDAError_srad_v1("copy back");

	time10 = get_time_srad_v1();
