...
void runTest_srad_v2( int argc, char** argv);
void usage_srad_v2(int argc, char **argv)
{
...
////////////////////////////////////////////////////////////////////////////////
int
main_srad_v2( int argc, char** argv)
{
  printf("WG size of kernel = %d X %d\n", BLOCK_SIZE, BLOCK_SIZE);
    runTest_srad_v2( argc, argv);
...
void
runTest_srad_v2( int argc, char** argv)
{
